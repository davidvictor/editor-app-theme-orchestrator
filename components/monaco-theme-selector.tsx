...
const LIGHT_THEME_OPTIONS = LIGHT_THEMES.map((theme) => ({
  value: theme,
  label: theme === 'vs' ? 'Visual Studio' : theme === 'hc-light' ? 'High Contrast Light' : theme,
}));
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      <div className="space-y-2">
        ...
        <Select value={lightTheme} onValueChange={onLightThemeChange}>
      ...
      <div className="space-y-2">
        ...
        <Select value={darkTheme} onValueChange={onDarkThemeChange}>
